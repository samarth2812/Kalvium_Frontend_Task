    ...
    <div>
        ...
        <ul className={styles.hello}>
            ...
            <ul className={styles.hello}>
                 ...
                 <Link className={styles.u} legacyBehavior href='/'><a className={styles.fer}><li> </li>Subject-wise attendence</a></Link> 
                <Link className={styles.u} legacyBehavior href='/Project'><a className={styles.fer}><li>Timetable</li></a></Link>
                <Link className={styles.u} legacyBehavior href='/attendence'><a className={styles.fer}><li>Mark your attendence</li></a></Link> 
            </ul>
